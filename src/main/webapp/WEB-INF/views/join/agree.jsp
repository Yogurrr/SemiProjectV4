...
Copyright © Kakao Corp. All rights reserved.
      ...
      <div class="form-check d-flex justify-content-end mt-3">
        <input type="checkbox" id="agreeone" class="form-check-input mx-2">
        <label for="agreeone" class="form-check-label text-primary">
          이용 약관에 동의합니다
        </label>
      </div>
    </form>
...
Copyright © Kakao Corp. All rights reserved.
      ...
      <div class="form-check d-flex justify-content-end mt-3">
        <input type="checkbox" id="agreetwo" class="form-check-input mx-2">
        <label for="agreetwo" class="form-check-label text-primary">
          개인정보 수집 및 이용에 동의합니다
        </label>
      </div>
    </form>
  ...
  <div class="text-center mt-3">
    <button type="button" class="btn btn-success " id="okagree">모두 동의합니다</button>
    <button type="button" class="btn btn-danger" id="noagree">동의하지 않습니다</button>
  </div>
</div>